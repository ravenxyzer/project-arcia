import { ChatInputCommand, ContextMenuCommand, Events, Identifiers, Listener, UserError } from "@sapphire/framework";
...
export class MessageCommandDeniedListener extends Listener {
    ...
    public async run(error: UserError, message: Message) {
        return handleCommandDenied(error, message);
    }
}
...
export class ChatInputCommandDeniedListener extends Listener {
    ...
    public async run(error: UserError, interaction: ChatInputCommand.Interaction) {
        return handleCommandDenied(error, interaction);
    }
}
...
function handleCommandDenied(error: UserError, interaction: ChatInputCommand.Interaction | ContextMenuCommand.Interaction | Message) {
